<div x-data="{ isOpen: false }">
    ...
    <button wire:click="open" @click="isOpen = !isOpen" class="focus:outline-none pt-3">
        <div class="relative">
            @if ($unseenCount > 0)
                <span
                    class="bg-red-500 absolute top-0 left-4 block h-4 w-4 rounded-full ring-2 ring-white text-xs text-white"
                    aria-hidden="true">{{ $unseenCount }}</span>
            @endif

            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 dark:text-gray-300" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
    ...
    <div x-show.transition="isOpen" class="fixed z-50 inset-0 overflow-hidden" aria-labelledby="slide-over-title"
        ...
        <div class="absolute inset-0 overflow-hidden bg-gray-500 bg-opacity-75 transition-opacity">
            ...
            <div class="fixed inset-y-0 right-0 pl-10 max-w-full flex sm:pl-16">
                ...
                <div class="w-screen max-w-md">
                    <div
                        class="h-full flex flex-col bg-white dark:bg-gray-700 dark:text-gray-300 shadow-xl overflow-y-scroll">
