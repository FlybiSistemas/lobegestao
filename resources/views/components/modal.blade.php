...
<div x-data="{ on: false }">
    ...
    <div class="fixed z-50 inset-x-0 sm:inset-0 sm:flex sm:items-center sm:justify-center" x-show="on">
        ...
        <div class="fixed inset-0 transition-opacity" x-show="on" x-on:close-modal.window="on = false"
        ...
        <div class="bg-white dark:bg-gray-600 dark:text-gray-200 rounded-lg overflow-scroll shadow-xl transform transition-all xs:w-full sm:w-full {{ $height }}"
